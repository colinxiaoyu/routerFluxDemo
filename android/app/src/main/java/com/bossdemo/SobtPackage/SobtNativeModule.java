...
public class SobtNativeModule extends ReactContextBaseJavaModule {


    public SobtNativeModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }

    @Override
    public String getName() {
        return "SobtNativeModule";
    }
    ...
    public void startSobot() {
        ...
        String appkey = "d05b795971a04c129dcc5d44b3cdd946";
//        SobotSPUtil.getStringData(context, "sobot_appkey", "");
